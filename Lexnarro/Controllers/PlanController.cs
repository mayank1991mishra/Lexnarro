...
namespace Lexnarro.Controllers
{
    ...
    public class PlanController : Controller
    {
        ...
        // GET: Plan_Master/Details/5
        public ActionResult Details(decimal? id)
        {
            if (id == null)
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);

            Plan_Master plan_Master = db.Plan_Master.Find(id);

            if (plan_Master == null)
                return HttpNotFound();
            
            return View(plan_Master);
        }


        // GET: Plan_Master/Create
        ...
        // POST: Plan_Master/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "Plan_ID,Plan")] Plan_Master plan_Master)
        {           
            try
            {
                //if (ModelState.IsValid)
                //{
                    var getName = db.Plan_Master.Where(u => u.Plan == plan_Master.Plan).ToList();
                    ...
                    {
                        db.Plan_Master.Add(plan_Master);
                        db.SaveChanges();
        ...
        public ActionResult DeleteConfirmed(decimal id)
        {
            ...
            {
                Plan_Master plan_Master = db.Plan_Master.Find(id);
                db.Plan_Master.Remove(plan_Master);
                db.SaveChanges();
