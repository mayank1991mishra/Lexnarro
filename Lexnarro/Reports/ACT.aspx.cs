...
User_Training_Status.Received_By_Forwarding, User_Training_Status.Units_Done, 
                         User_Training_Status.Min_Required_Category_Units, User_Profile.FirstName, User_Profile.LastName, 
User_Profile.OtherName, User_Profile.StreetNumber, User_Profile.StreetName, User_Profile.PostCode, 
                         User_Profile.Suburb, User_Profile.LawSocietyNumber, User_Profile.EmailAddress, User_Profile.PhoneNumber, 
User_Profile.Address, User_Training_Transaction.Your_Role, Country_Master.Name AS 'Country Name', 
                         ...
                         where User_Training_Transaction.User_Id = " + userid + " and User_Training_Transaction.Financial_Year = '" + finYear + "'";
                            ...
                            data.Clear();
                            adap.Fill(data, "Report_ACT");
                            n = data.Tables["Report_ACT"].Rows.Count;
