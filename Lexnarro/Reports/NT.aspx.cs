...
{
    public partial class NT : System.Web.UI.Page
    {
        public DataSet data = new DataSet();
        public string yearFrom = "";
        public string yearTo = "";
        public string previousFinacialYear = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //    previousFinacialYear = PreYear + "-" + CurYear;
                //}
                //else
                //{
                //    FinYear = PreYear + "-" + CurYear;
                //    previousFinacialYear = (DateTime.Today.Year - 2).ToString() + "-" + (DateTime.Today.Year - 1).ToString();
                //}
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    using (SqlDataAdapter adap = new SqlDataAdapter())
                    {
                        ...
                        User_Training_Status.Units_Done, 
